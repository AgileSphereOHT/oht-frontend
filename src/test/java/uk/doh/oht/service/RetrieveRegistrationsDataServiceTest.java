...
import uk.doh.oht.config.DataProperties;
import uk.doh.oht.domain.PendingRegistrationData;
import uk.doh.oht.domain.RegistrationData;
import uk.doh.oht.domain.SearchData;
import uk.doh.oht.domain.UserWorkDetails;
...
public class RetrieveRegistrationsDataServiceTest {
    ...
    public void testRetrieveUserWorkData() throws Exception {
        final UserWorkDetails userWorkDetails =  new UserWorkDetails(null, 1l, 2l, 3l);
        ...
        final UserWorkDetails userWorkDetails1 = retrieveRegistrationsDataService.retrieveUserWorkData("test");
